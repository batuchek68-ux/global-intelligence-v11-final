    ...
    return [
        {
            ...
            "official_source_status": "search_plan_only",
            "project_record_status": "candidate_project",
            "verified_project_allowed": False,
            "candidate_to_verified_gate": {
                "status": "candidate_project",
                "verified_project_allowed": False,
                "official_source_status": "search_plan_only",
                "required_before_verified_project": [
                    "Attach at least one Tier 1 official government, procurement, customs, regulator, or authority source.",
                    "Confirm the project stage as planned or under_construction.",
                    "Identify the owner or responsible authority candidate.",
                    "Identify the developer, investor, or contractor candidate.",
                    "Keep all external use blocked until human approval.",
                ],
                "missing_requirements": [
                    "Official evidence has not been collected yet; this is only a search plan.",
                ],
            },
