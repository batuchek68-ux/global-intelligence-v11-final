...
def build_acceptance_status() -> dict:
    ...
    checks = [
        ...
        check_text(".github/workflows/international_trade_ops.yml", "python backend/workflows/daily_job.py"),
        check_text(".github/workflows/international_trade_ops.yml", "python backend/workflows/persist_state.py"),
        check_text(".github/workflows/owner_decision.yml", "issue_comment"),
        check_text(".github/workflows/owner_decision.yml", "python backend/workflows/resolve_major_matter.py"),
        check_text(".github/workflows/watchdog.yml", "python backend/workflows/persist_state.py"),
        check_text(".github/workflows/cloud_acceptance.yml", "python backend/workflows/cloud_acceptance.py"),
        check_text(".github/workflows/codex_autonomous_repair.yml", "python backend/workflows/autonomous_repair.py"),
