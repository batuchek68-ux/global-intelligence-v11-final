...
REQUIRED_TEXT = {
    ".github/workflows/international_trade_ops.yml": [
        ...
        "python backend/workflows/publish_summary.py",
        "python backend/workflows/persist_state.py",
        "reports/",
    ],
    ".github/workflows/owner_decision.yml": [
        "issue_comment",
        ...
        "python backend/workflows/resolve_major_matter.py",
        "python backend/workflows/persist_state.py",
    ],
    ".github/workflows/watchdog.yml": [
        "0 */6 * * *",
    ...
    ".github/workflows/codex_autonomous_repair.yml": [
        "workflow_dispatch",
        "schedule:",
        "python backend/workflows/autonomous_repair.py",
        "python backend/workflows/persist_state.py",
