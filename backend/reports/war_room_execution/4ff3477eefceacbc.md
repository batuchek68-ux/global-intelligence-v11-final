...
### 4ff3477eefceacbc-01 | research_analyst
- Status: open
...
### 4ff3477eefceacbc-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4ff3477eefceacbc-09 | risk_approval_officer
- Status: blocked
...
### 4ff3477eefceacbc-10 | project_manager
- Status: open
...
### 4ff3477eefceacbc-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4ff3477eefceacbc-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4ff3477eefceacbc-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4ff3477eefceacbc-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4ff3477eefceacbc-15 | trade_lead
- Status: open
...
### 4ff3477eefceacbc-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4ff3477eefceacbc-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4ff3477eefceacbc-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4ff3477eefceacbc-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4ff3477eefceacbc-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4ff3477eefceacbc-21 | trade_lead
- Status: open
...
### 4ff3477eefceacbc-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 4ff3477eefceacbc-23 | investment_promotion_lead
- Status: blocked
...
### 4ff3477eefceacbc-24 | video_media_producer
- Status: blocked
...
### 4ff3477eefceacbc-25 | project_manager
- Status: open
...
### 4ff3477eefceacbc-26 | risk_approval_officer
...
### 4ff3477eefceacbc-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 4ff3477eefceacbc-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4ff3477eefceacbc-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4ff3477eefceacbc-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4ff3477eefceacbc-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4ff3477eefceacbc-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
