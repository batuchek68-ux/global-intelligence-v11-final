...
### 3e9f9f354d61393a-01 | research_analyst
- Status: open
...
### 3e9f9f354d61393a-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3e9f9f354d61393a-09 | risk_approval_officer
- Status: blocked
...
### 3e9f9f354d61393a-10 | project_manager
- Status: open
...
### 3e9f9f354d61393a-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3e9f9f354d61393a-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3e9f9f354d61393a-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3e9f9f354d61393a-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3e9f9f354d61393a-15 | trade_lead
- Status: open
...
### 3e9f9f354d61393a-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3e9f9f354d61393a-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3e9f9f354d61393a-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3e9f9f354d61393a-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3e9f9f354d61393a-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3e9f9f354d61393a-21 | trade_lead
- Status: open
...
### 3e9f9f354d61393a-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 3e9f9f354d61393a-23 | investment_promotion_lead
- Status: blocked
...
### 3e9f9f354d61393a-24 | video_media_producer
- Status: blocked
...
### 3e9f9f354d61393a-25 | project_manager
- Status: open
...
### 3e9f9f354d61393a-26 | risk_approval_officer
...
### 3e9f9f354d61393a-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 3e9f9f354d61393a-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3e9f9f354d61393a-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3e9f9f354d61393a-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3e9f9f354d61393a-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3e9f9f354d61393a-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
