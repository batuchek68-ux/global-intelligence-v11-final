...
### 2975e00f597a8c60-01 | research_analyst
- Status: open
...
### 2975e00f597a8c60-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2975e00f597a8c60-09 | risk_approval_officer
- Status: blocked
...
### 2975e00f597a8c60-10 | project_manager
- Status: open
...
### 2975e00f597a8c60-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2975e00f597a8c60-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2975e00f597a8c60-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2975e00f597a8c60-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2975e00f597a8c60-15 | trade_lead
- Status: open
...
### 2975e00f597a8c60-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2975e00f597a8c60-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2975e00f597a8c60-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2975e00f597a8c60-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2975e00f597a8c60-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2975e00f597a8c60-21 | trade_lead
- Status: open
...
### 2975e00f597a8c60-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 2975e00f597a8c60-23 | investment_promotion_lead
- Status: blocked
...
### 2975e00f597a8c60-24 | video_media_producer
- Status: blocked
...
### 2975e00f597a8c60-25 | project_manager
- Status: open
...
### 2975e00f597a8c60-26 | risk_approval_officer
...
### 2975e00f597a8c60-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 2975e00f597a8c60-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2975e00f597a8c60-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2975e00f597a8c60-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2975e00f597a8c60-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2975e00f597a8c60-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
