...
### 404bd8b0f8765a8d-01 | research_analyst
- Status: open
...
### 404bd8b0f8765a8d-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 404bd8b0f8765a8d-09 | risk_approval_officer
- Status: blocked
...
### 404bd8b0f8765a8d-10 | project_manager
- Status: open
...
### 404bd8b0f8765a8d-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 404bd8b0f8765a8d-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 404bd8b0f8765a8d-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 404bd8b0f8765a8d-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 404bd8b0f8765a8d-15 | trade_lead
- Status: open
...
### 404bd8b0f8765a8d-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 404bd8b0f8765a8d-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 404bd8b0f8765a8d-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 404bd8b0f8765a8d-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 404bd8b0f8765a8d-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 404bd8b0f8765a8d-21 | trade_lead
- Status: open
...
### 404bd8b0f8765a8d-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 404bd8b0f8765a8d-23 | investment_promotion_lead
- Status: blocked
...
### 404bd8b0f8765a8d-24 | video_media_producer
- Status: blocked
...
### 404bd8b0f8765a8d-25 | project_manager
- Status: open
...
### 404bd8b0f8765a8d-26 | risk_approval_officer
...
### 404bd8b0f8765a8d-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 404bd8b0f8765a8d-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 404bd8b0f8765a8d-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 404bd8b0f8765a8d-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 404bd8b0f8765a8d-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 404bd8b0f8765a8d-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
