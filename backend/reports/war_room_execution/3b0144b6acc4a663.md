...
### 3b0144b6acc4a663-01 | research_analyst
- Status: open
...
### 3b0144b6acc4a663-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3b0144b6acc4a663-09 | risk_approval_officer
- Status: blocked
...
### 3b0144b6acc4a663-10 | project_manager
- Status: open
...
### 3b0144b6acc4a663-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3b0144b6acc4a663-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3b0144b6acc4a663-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3b0144b6acc4a663-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3b0144b6acc4a663-15 | trade_lead
- Status: open
...
### 3b0144b6acc4a663-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3b0144b6acc4a663-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3b0144b6acc4a663-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3b0144b6acc4a663-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3b0144b6acc4a663-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3b0144b6acc4a663-21 | trade_lead
- Status: open
...
### 3b0144b6acc4a663-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 3b0144b6acc4a663-23 | investment_promotion_lead
- Status: blocked
...
### 3b0144b6acc4a663-24 | video_media_producer
- Status: blocked
...
### 3b0144b6acc4a663-25 | project_manager
- Status: open
...
### 3b0144b6acc4a663-26 | risk_approval_officer
...
### 3b0144b6acc4a663-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 3b0144b6acc4a663-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3b0144b6acc4a663-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3b0144b6acc4a663-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3b0144b6acc4a663-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3b0144b6acc4a663-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
