...
### 2ae0fea1edee0450-01 | research_analyst
- Status: open
...
### 2ae0fea1edee0450-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 2ae0fea1edee0450-09 | risk_approval_officer
- Status: blocked
...
### 2ae0fea1edee0450-10 | project_manager
- Status: open
...
### 2ae0fea1edee0450-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2ae0fea1edee0450-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2ae0fea1edee0450-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2ae0fea1edee0450-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 2ae0fea1edee0450-15 | trade_lead
- Status: open
...
### 2ae0fea1edee0450-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2ae0fea1edee0450-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2ae0fea1edee0450-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2ae0fea1edee0450-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2ae0fea1edee0450-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 2ae0fea1edee0450-21 | trade_lead
- Status: open
...
### 2ae0fea1edee0450-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 2ae0fea1edee0450-23 | investment_promotion_lead
- Status: blocked
...
### 2ae0fea1edee0450-24 | video_media_producer
- Status: blocked
...
### 2ae0fea1edee0450-25 | project_manager
- Status: open
...
### 2ae0fea1edee0450-26 | risk_approval_officer
...
### 2ae0fea1edee0450-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 2ae0fea1edee0450-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2ae0fea1edee0450-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2ae0fea1edee0450-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2ae0fea1edee0450-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 2ae0fea1edee0450-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
