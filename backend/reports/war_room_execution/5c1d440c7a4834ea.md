...
### 5c1d440c7a4834ea-01 | research_analyst
- Status: open
...
### 5c1d440c7a4834ea-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 5c1d440c7a4834ea-09 | risk_approval_officer
- Status: blocked
...
### 5c1d440c7a4834ea-10 | project_manager
- Status: open
...
### 5c1d440c7a4834ea-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 5c1d440c7a4834ea-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 5c1d440c7a4834ea-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 5c1d440c7a4834ea-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 5c1d440c7a4834ea-15 | trade_lead
- Status: open
...
### 5c1d440c7a4834ea-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 5c1d440c7a4834ea-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 5c1d440c7a4834ea-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 5c1d440c7a4834ea-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 5c1d440c7a4834ea-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 5c1d440c7a4834ea-21 | trade_lead
- Status: open
...
### 5c1d440c7a4834ea-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 5c1d440c7a4834ea-23 | investment_promotion_lead
- Status: blocked
...
### 5c1d440c7a4834ea-24 | video_media_producer
- Status: blocked
...
### 5c1d440c7a4834ea-25 | project_manager
- Status: open
...
### 5c1d440c7a4834ea-26 | risk_approval_officer
...
### 5c1d440c7a4834ea-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 5c1d440c7a4834ea-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 5c1d440c7a4834ea-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 5c1d440c7a4834ea-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 5c1d440c7a4834ea-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 5c1d440c7a4834ea-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
