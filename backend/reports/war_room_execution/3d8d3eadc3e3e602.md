...
### 3d8d3eadc3e3e602-01 | research_analyst
- Status: open
...
### 3d8d3eadc3e3e602-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 3d8d3eadc3e3e602-09 | project_manager
- Status: open
...
### 3d8d3eadc3e3e602-10 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3d8d3eadc3e3e602-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3d8d3eadc3e3e602-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3d8d3eadc3e3e602-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 3d8d3eadc3e3e602-14 | trade_lead
- Status: open
...
### 3d8d3eadc3e3e602-15 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3d8d3eadc3e3e602-16 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3d8d3eadc3e3e602-17 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3d8d3eadc3e3e602-18 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3d8d3eadc3e3e602-19 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 3d8d3eadc3e3e602-20 | trade_lead
- Status: open
...
### 3d8d3eadc3e3e602-21 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 3d8d3eadc3e3e602-22 | investment_promotion_lead
- Status: blocked
...
### 3d8d3eadc3e3e602-23 | video_media_producer
- Status: blocked
...
### 3d8d3eadc3e3e602-24 | project_manager
- Status: open
...
### 3d8d3eadc3e3e602-25 | risk_approval_officer
...
### 3d8d3eadc3e3e602-26 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 3d8d3eadc3e3e602-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3d8d3eadc3e3e602-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3d8d3eadc3e3e602-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3d8d3eadc3e3e602-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 3d8d3eadc3e3e602-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
