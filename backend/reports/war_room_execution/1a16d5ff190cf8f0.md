...
### 1a16d5ff190cf8f0-01 | research_analyst
- Status: open
...
### 1a16d5ff190cf8f0-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 1a16d5ff190cf8f0-09 | risk_approval_officer
- Status: blocked
...
### 1a16d5ff190cf8f0-10 | project_manager
- Status: open
...
### 1a16d5ff190cf8f0-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 1a16d5ff190cf8f0-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 1a16d5ff190cf8f0-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 1a16d5ff190cf8f0-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 1a16d5ff190cf8f0-15 | trade_lead
- Status: open
...
### 1a16d5ff190cf8f0-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 1a16d5ff190cf8f0-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 1a16d5ff190cf8f0-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 1a16d5ff190cf8f0-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 1a16d5ff190cf8f0-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 1a16d5ff190cf8f0-21 | trade_lead
- Status: open
...
### 1a16d5ff190cf8f0-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 1a16d5ff190cf8f0-23 | investment_promotion_lead
- Status: blocked
...
### 1a16d5ff190cf8f0-24 | video_media_producer
- Status: blocked
...
### 1a16d5ff190cf8f0-25 | project_manager
- Status: open
...
### 1a16d5ff190cf8f0-26 | risk_approval_officer
...
### 1a16d5ff190cf8f0-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 1a16d5ff190cf8f0-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 1a16d5ff190cf8f0-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 1a16d5ff190cf8f0-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 1a16d5ff190cf8f0-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 1a16d5ff190cf8f0-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
