...
### 535058bc7aae67a1-01 | research_analyst
- Status: open
...
### 535058bc7aae67a1-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 535058bc7aae67a1-09 | risk_approval_officer
- Status: blocked
...
### 535058bc7aae67a1-10 | project_manager
- Status: open
...
### 535058bc7aae67a1-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 535058bc7aae67a1-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 535058bc7aae67a1-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 535058bc7aae67a1-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 535058bc7aae67a1-15 | trade_lead
- Status: open
...
### 535058bc7aae67a1-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 535058bc7aae67a1-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 535058bc7aae67a1-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 535058bc7aae67a1-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 535058bc7aae67a1-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 535058bc7aae67a1-21 | trade_lead
- Status: open
...
### 535058bc7aae67a1-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 535058bc7aae67a1-23 | investment_promotion_lead
- Status: blocked
...
### 535058bc7aae67a1-24 | video_media_producer
- Status: blocked
...
### 535058bc7aae67a1-25 | project_manager
- Status: open
...
### 535058bc7aae67a1-26 | risk_approval_officer
...
### 535058bc7aae67a1-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 535058bc7aae67a1-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 535058bc7aae67a1-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 535058bc7aae67a1-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 535058bc7aae67a1-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 535058bc7aae67a1-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
