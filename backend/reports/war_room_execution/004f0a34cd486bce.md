...
### 004f0a34cd486bce-01 | research_analyst
- Status: open
...
### 004f0a34cd486bce-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 004f0a34cd486bce-09 | risk_approval_officer
- Status: blocked
...
### 004f0a34cd486bce-10 | project_manager
- Status: open
...
### 004f0a34cd486bce-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 004f0a34cd486bce-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 004f0a34cd486bce-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 004f0a34cd486bce-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 004f0a34cd486bce-15 | trade_lead
- Status: open
...
### 004f0a34cd486bce-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 004f0a34cd486bce-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 004f0a34cd486bce-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 004f0a34cd486bce-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 004f0a34cd486bce-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 004f0a34cd486bce-21 | trade_lead
- Status: open
...
### 004f0a34cd486bce-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 004f0a34cd486bce-23 | investment_promotion_lead
- Status: blocked
...
### 004f0a34cd486bce-24 | video_media_producer
- Status: blocked
...
### 004f0a34cd486bce-25 | project_manager
- Status: open
...
### 004f0a34cd486bce-26 | risk_approval_officer
...
### 004f0a34cd486bce-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 004f0a34cd486bce-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 004f0a34cd486bce-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 004f0a34cd486bce-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 004f0a34cd486bce-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 004f0a34cd486bce-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
