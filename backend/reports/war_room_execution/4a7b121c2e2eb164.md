...
### 4a7b121c2e2eb164-01 | research_analyst
- Status: open
...
### 4a7b121c2e2eb164-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 4a7b121c2e2eb164-09 | risk_approval_officer
- Status: blocked
...
### 4a7b121c2e2eb164-10 | project_manager
- Status: open
...
### 4a7b121c2e2eb164-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4a7b121c2e2eb164-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4a7b121c2e2eb164-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4a7b121c2e2eb164-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 4a7b121c2e2eb164-15 | trade_lead
- Status: open
...
### 4a7b121c2e2eb164-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4a7b121c2e2eb164-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4a7b121c2e2eb164-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4a7b121c2e2eb164-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4a7b121c2e2eb164-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 4a7b121c2e2eb164-21 | trade_lead
- Status: open
...
### 4a7b121c2e2eb164-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 4a7b121c2e2eb164-23 | investment_promotion_lead
- Status: blocked
...
### 4a7b121c2e2eb164-24 | video_media_producer
- Status: blocked
...
### 4a7b121c2e2eb164-25 | project_manager
- Status: open
...
### 4a7b121c2e2eb164-26 | risk_approval_officer
...
### 4a7b121c2e2eb164-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 4a7b121c2e2eb164-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4a7b121c2e2eb164-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4a7b121c2e2eb164-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4a7b121c2e2eb164-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 4a7b121c2e2eb164-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
