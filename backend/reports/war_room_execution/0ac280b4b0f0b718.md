...
### 0ac280b4b0f0b718-01 | research_analyst
- Status: open
...
### 0ac280b4b0f0b718-02 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-03 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-04 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-05 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-06 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-07 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-08 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: search_confirmation.government_confirmation
...
### 0ac280b4b0f0b718-09 | risk_approval_officer
- Status: blocked
...
### 0ac280b4b0f0b718-10 | project_manager
- Status: open
...
### 0ac280b4b0f0b718-11 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 0ac280b4b0f0b718-12 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 0ac280b4b0f0b718-13 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 0ac280b4b0f0b718-14 | project_manager
- Status: open
- Risk gate: owner_review
- Source: project_execution.next_actions
...
### 0ac280b4b0f0b718-15 | trade_lead
- Status: open
...
### 0ac280b4b0f0b718-16 | research_analyst
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 0ac280b4b0f0b718-17 | investment_promotion_lead
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 0ac280b4b0f0b718-18 | video_media_producer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 0ac280b4b0f0b718-19 | project_manager
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 0ac280b4b0f0b718-20 | risk_approval_officer
- Status: open
- Risk gate: standard_review
- Source: team.roles.next_step
...
### 0ac280b4b0f0b718-21 | trade_lead
- Status: open
...
### 0ac280b4b0f0b718-22 | research_analyst
- Status: open
- Risk gate: evidence_required
- Source: action_board.tasks
...
### 0ac280b4b0f0b718-23 | investment_promotion_lead
- Status: blocked
...
### 0ac280b4b0f0b718-24 | video_media_producer
- Status: blocked
...
### 0ac280b4b0f0b718-25 | project_manager
- Status: open
...
### 0ac280b4b0f0b718-26 | risk_approval_officer
...
### 0ac280b4b0f0b718-27 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
...
### 0ac280b4b0f0b718-28 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 0ac280b4b0f0b718-29 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 0ac280b4b0f0b718-30 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 0ac280b4b0f0b718-31 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
...
### 0ac280b4b0f0b718-32 | video_media_producer
- Status: blocked
- Risk gate: blocked_before_external_use
- Source: video_center.platform_searches
