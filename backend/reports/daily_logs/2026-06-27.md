...
- News update: `backend/reports/news_updates/2026-06-27.md`
- Project library report: `backend/reports/project_library/2026-06-27.md`
- Project library database: `backend/projects/library/kazakhstan_xinjiang_projects.json`
- Customs watch snapshot: `backend/memory/monitoring/customs_watch/2026-06-27.json`
