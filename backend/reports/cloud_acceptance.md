...
- Status: PASS
- Generated: 2026-06-24T12:33:44.533538+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=228, action_reports=228, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=18, reports=18, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=3, boards=227, responses=8, war_rooms=4, queues=18, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
