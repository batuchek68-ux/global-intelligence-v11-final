...
- Status: PASS
- Generated: 2026-07-04T15:00:50.555947+00:00
- Repository: local
- Run id: local
...
- PASS `v11_action_board:execution_tasks` - action_json=453, action_reports=453, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=154, reports=154, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=452, responses=52, war_rooms=26, queues=153, queue_tasks=31, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
