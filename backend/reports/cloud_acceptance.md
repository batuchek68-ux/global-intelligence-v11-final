...
- Status: PASS
- Generated: 2026-08-31T14:24:44.858606+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=1820, action_reports=1820, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=975, reports=975, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=1819, responses=284, war_rooms=142, queues=975, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
