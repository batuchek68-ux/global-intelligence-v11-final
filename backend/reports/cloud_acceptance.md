...
- Status: PASS
- Generated: 2026-07-10T18:12:12.725665+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=565, action_reports=565, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=222, reports=222, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=564, responses=76, war_rooms=38, queues=222, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
