...
- Status: PASS
- Generated: 2026-09-12T05:55:43.618911+00:00
...
- intelligence_briefs: 82
- video_center_files: 82
...
- war_rooms: 166
- war_room_execution_queues: 1143
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=82
- PASS `v11_video:center_generated` - video_files=82, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=2100, action_reports=2100, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=333, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=166, saved_reports=166, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=1143, reports=1143, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=2099, responses=332, war_rooms=166, queues=1143, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
