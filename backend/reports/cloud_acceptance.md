...
- Status: PASS
- Generated: 2026-09-24T17:32:38.985560+00:00
...
- intelligence_briefs: 94
- video_center_files: 94
...
- war_rooms: 190
- war_room_execution_queues: 1326
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=94
- PASS `v11_video:center_generated` - video_files=94, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=2405, action_reports=2405, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=381, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=190, saved_reports=190, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=1326, reports=1326, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=2404, responses=380, war_rooms=190, queues=1326, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
