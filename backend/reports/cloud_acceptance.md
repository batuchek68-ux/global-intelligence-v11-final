...
- Status: PASS
- Generated: 2026-08-08T03:01:27.692348+00:00
...
- intelligence_briefs: 47
- video_center_files: 47
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=47
- PASS `v11_video:center_generated` - video_files=47, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=1260, action_reports=1260, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=193, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=96, saved_reports=96, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=639, reports=639, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=1259, responses=192, war_rooms=96, queues=639, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
