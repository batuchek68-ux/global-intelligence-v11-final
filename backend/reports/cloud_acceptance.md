...
- Status: PASS
- Generated: 2026-06-27T16:43:41.955251+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=328, action_reports=328, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=79, reports=79, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=327, responses=24, war_rooms=12, queues=79, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
