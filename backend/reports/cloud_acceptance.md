...
- Status: PASS
- Generated: 2026-07-04T13:46:02.469656+00:00
- Repository: local
- Run id: local
...
- PASS `v11_action_board:execution_tasks` - action_json=443, action_reports=443, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=147, reports=147, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=442, responses=52, war_rooms=26, queues=147, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
