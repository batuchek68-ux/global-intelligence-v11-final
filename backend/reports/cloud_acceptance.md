...
- Status: PASS
- Generated: 2026-07-12T09:12:12.634109+00:00
...
- intelligence_briefs: 20
- video_center_files: 20
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=20
...
- PASS `v11_action_board:execution_tasks` - action_json=595, action_reports=595, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=240, reports=240, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=594, responses=84, war_rooms=42, queues=240, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
