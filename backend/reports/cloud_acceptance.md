...
- Status: PASS
- Generated: 2026-07-03T11:58:28.708212+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=403, action_reports=403, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=124, reports=124, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=402, responses=48, war_rooms=24, queues=124, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
