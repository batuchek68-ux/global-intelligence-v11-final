...
- Status: PASS
- Generated: 2026-08-07T19:37:36.829093+00:00
...
- intelligence_briefs: 46
- video_center_files: 46
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=46
- PASS `v11_video:center_generated` - video_files=46, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=1255, action_reports=1255, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=189, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=94, saved_reports=94, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=636, reports=636, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=1254, responses=188, war_rooms=94, queues=636, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
