...
- Status: PASS
- Generated: 2026-06-24T18:25:25.438895+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=245, action_reports=245, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=29, reports=29, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=3, boards=244, responses=8, war_rooms=4, queues=29, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
