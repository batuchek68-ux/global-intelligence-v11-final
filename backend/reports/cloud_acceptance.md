...
- Status: PASS
- Generated: 2026-09-14T13:20:51.223999+00:00
...
- intelligence_briefs: 84
- video_center_files: 84
...
- war_rooms: 170
- war_room_execution_queues: 1179
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=84
- PASS `v11_video:center_generated` - video_files=84, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=2160, action_reports=2160, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=341, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=170, saved_reports=170, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=1179, reports=1179, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=2159, responses=340, war_rooms=170, queues=1179, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
