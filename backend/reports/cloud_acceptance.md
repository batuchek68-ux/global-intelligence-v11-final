...
- Status: PASS
- Generated: 2026-08-11T19:44:17.362166+00:00
...
- PASS `v11_action_board:execution_tasks` - action_json=1355, action_reports=1355, latest_tasks=6, latest_status=pending_owner
...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=696, reports=696, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=1354, responses=204, war_rooms=102, queues=696, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
