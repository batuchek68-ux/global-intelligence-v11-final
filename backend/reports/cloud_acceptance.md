...
- Status: PASS
- Generated: 2026-09-18T21:15:02.186494+00:00
...
- intelligence_briefs: 88
- video_center_files: 88
...
- war_rooms: 178
- war_room_execution_queues: 1242
...
- PASS `v11_intelligence:keyword_bank_and_brief` - keywords=211, briefs=88
- PASS `v11_video:center_generated` - video_files=88, platform_searches=120
...
- PASS `v11_action_board:execution_tasks` - action_json=2265, action_reports=2265, latest_tasks=6, latest_status=pending_owner
- PASS `v11_team_response:team_answer_pack` - team_response_json=357, score=99, roles=6
...
- PASS `v11_war_room:vertical_team_operating_package` - latest=industry_war_room, saved_json=178, saved_reports=178, mode=industry_war_room, search_gate=lead_only, promotion=lead_only, roles=6, video=12, score=99
- PASS `v11_war_room_execution:queue_tracks_work` - queues=1242, reports=1242, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=2264, responses=356, war_rooms=178, queues=1242, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
