...
- PASS `v11_war_room_execution:queue_tracks_work` - queues=76, reports=76, mode=war_room_execution_queue, tasks=32, open=22, blocked=10, approval=13
- PASS `v11_mission_control:operating_brief` - status=human_review_required, benchmark=50, customs=True, evidence=4, boards=322, responses=24, war_rooms=12, queues=76, queue_tasks=32, war_score=99, search_gate=lead_only, promotion_gate=draft_promotion_ready
